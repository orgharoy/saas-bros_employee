...
const NewUserCounter = () => {
  return (
    <div className="py-3 px-5 rounded-md border border-purple-400 h-full relative overflow-hidden text-purple-600">
        <h1 className='z-10'>New Users</h1>
        <h1 className='text-5xl font-extrabold z-10'>10</h1>

        <div className="flex items-center text-green-800 z-30 pt-1">
        ...
        <div className="absolute -bottom-5 -right-3 text-purple-200">
