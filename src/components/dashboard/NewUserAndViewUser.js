...
const NewUserAndViewUser = () => {
  return (
    <div className="py-3 rounded-md border border-purple-7 text-black h-full grid grid-cols-2 overflow-hidden">
        <Link to="/register-business" className="mx-5 border-r border-r-purple-7 flex items-center relative" >
