      ...
      <div>
        ...
        <div className="grid grid-cols-3 mb-5 gap-5">
          ...
          <div className="col-span-2">
            <h1 className="text-purple-5 font-normal text-sm">Business Description</h1>
            <h1>{formValues.businessDescription}</h1>
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business Email</h1>
            <h1>{formValues.businessEmail}</h1>
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business Address</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business State</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business Country</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business Tyype</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Business Sales Volumne</h1>
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Email</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Phone</h1>
            <h1>{formValues.merchantPhone}</h1>
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Address 1</h1>
            <h1>{formValues.merchantAddress1}</h1>
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Address 2</h1>
          ...
          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant State</h1>
            <h1>{formValues.merchantState}</h1>  
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Zip Code</h1>
            <h1>{formValues.merchantZipcode}</h1> 
          </div>

          <div>
            <h1 className="text-purple-5 font-normal text-sm">Merchant Country</h1>
